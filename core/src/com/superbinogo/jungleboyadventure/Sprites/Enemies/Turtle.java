package com.superbinogo.jungleboyadventure.Sprites.Enemies;
...
public class Turtle extends Enemy {
    ...
    public Turtle(PlayScreen screen, float x, float y) {
        ...
        frames.add(new TextureRegion(screen.getEnemiesAtlas().findRegion("turtle"), 0, 0, 16, 24));
        frames.add(new TextureRegion(screen.getEnemiesAtlas().findRegion("turtle"), 16, 0, 16, 24));
        shell = new TextureRegion(screen.getEnemiesAtlas().findRegion("turtle"), 64, 0, 16, 24);
