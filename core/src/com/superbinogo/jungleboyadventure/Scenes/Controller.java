package com.superbinogo.jungleboyadventure.Scenes;
...
public class Controller {
    ...
    public Controller(MarioBros superBinoGo) {
        cam = new OrthographicCamera();
        viewport = new FitViewport(MarioBros.V_WIDTH / MarioBros.PPM, MarioBros.V_HEIGHT / MarioBros.PPM, cam);
