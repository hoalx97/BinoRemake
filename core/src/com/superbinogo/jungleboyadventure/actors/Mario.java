package com.superbinogo.jungleboyadventure.actors;
...
import com.superbinogo.jungleboyadventure.actors.items.Item;
import com.superbinogo.jungleboyadventure.gamesys.GameManager;
import com.superbinogo.jungleboyadventure.hud.Controller;
...
public class Mario extends RigidBody {
    ...
    private final float normalForce = 5f;
    private final float normalSpeedMax = 5f;
    private final float fastForce = 5f;
    private final float fastSpeedMax = 5f;
    ...
    private final Animation<TextureRegion> runningSmall;
    private final TextureRegion brakingSmall;
    private final Animation<TextureRegion> climbingSmall;

    private final TextureRegion standingBig;
    private final TextureRegion jumpingBig;
    private final Animation<TextureRegion> runningBig;
    private final TextureRegion brakingBig;
    private final TextureRegion crouchingBig;
    private final Animation<TextureRegion> climbingBig;

    private final TextureRegion standingFireMario;
    private final TextureRegion jumpingFireMario;
    private final Animation<TextureRegion> runningFireMario;
    private final TextureRegion brakingFireMario;
    private final TextureRegion crouchingFireMario;
    private final Animation<TextureRegion> climbingFireMario;

    private final TextureRegion[] standingSmallInvincible;
    private final TextureRegion[] jumpingSmallInvincible;
    private final Animation<TextureRegion>[] runningSmallInvincible;
    private final TextureRegion[] brakingSmallInvincible;
    private final Animation<TextureRegion>[] climbingSmallInvincible;

    private final TextureRegion[] standingBigInvincible;
    private final TextureRegion[] jumpingBigInvincible;
    private final Animation<TextureRegion>[] runningBigInvincible;
    private final TextureRegion[] brakingBigInvincible;
    private final TextureRegion[] crouchingBigInvincible;
    private final Animation<TextureRegion>[] firingBigInvincible;
    private final Animation<TextureRegion>[] climbingBigInvincible;

    private final TextureRegion dying;
    private final Animation<TextureRegion> growing;
    private final Animation<TextureRegion> fireMarioing;
    private final Animation<TextureRegion> shrinking;
    private final Animation<TextureRegion> firingAnimation;
    ...
    public Mario(PlayScreen playScreen, float x, float y, Controller controller) {
...
//        }
        ...
        if (controller.isUpPressed() && currentState == State.JUMPING) {
            if (keyPressedTime > 0.1f && keyPressedTime < 0.15f) {
                body.applyLinearImpulse(new Vector2(0.0f, 5.0f), body.getWorldCenter(), true);
                keyPressedTime = 99.0f;
                bigJump = true;
...
//        }
        ...
        // Move left
        if (controller.isLeftPressed() && !crouch) {
//            body.applyForceToCenter(new Vector2(-force, 0.0f), true);
        ...
        // Move right
        if (controller.isRightPressed() && !crouch) {
//            body.applyForceToCenter(new Vector2(force, 0.0f), true);
            body.setLinearVelocity(force, body.getLinearVelocity().y);
            if (body.getLinearVelocity().x < -normalSpeedMax || (currentState == State.BRAKING && body.getLinearVelocity().x < 0)) {
                brake = true;
