package com.superbinogo.jungleboyadventure.screens;
...
import com.superbinogo.jungleboyadventure.SuperMario;
import com.superbinogo.jungleboyadventure.WorldContactListener;
import com.superbinogo.jungleboyadventure.WorldCreator;
import com.superbinogo.jungleboyadventure.actors.Mario;
import com.superbinogo.jungleboyadventure.actors.effects.BrickDebris;
import com.superbinogo.jungleboyadventure.actors.effects.Effect;
import com.superbinogo.jungleboyadventure.actors.effects.FlippingCoin;
import com.superbinogo.jungleboyadventure.actors.effects.SpawningEffect;
import com.superbinogo.jungleboyadventure.actors.enemies.Enemy;
import com.superbinogo.jungleboyadventure.actors.items.Flower;
import com.superbinogo.jungleboyadventure.actors.items.Item;
import com.superbinogo.jungleboyadventure.actors.items.Mushroom;
import com.superbinogo.jungleboyadventure.actors.items.SpawningItem;
import com.superbinogo.jungleboyadventure.actors.items.Star;
import com.superbinogo.jungleboyadventure.actors.maptiles.MapTileObject;
import com.superbinogo.jungleboyadventure.actors.stageitems.Flag;
import com.superbinogo.jungleboyadventure.actors.weapons.Fireball;
import com.superbinogo.jungleboyadventure.actors.weapons.SpawningFireball;
import com.superbinogo.jungleboyadventure.gamesys.GameManager;
import com.superbinogo.jungleboyadventure.hud.Controller;
import com.superbinogo.jungleboyadventure.hud.Hud;
import com.superbinogo.jungleboyadventure.hud.ScoreIndicator;
...
//    private float mapHeight; // currently not used
    ...
    public void show() {
        ...
        viewport = new FillViewport(GameManager.V_WIDTH, GameManager.V_HEIGHT);
        ...
        tiledMap = tmxMapLoader.load("tmx/level1.tmx");
...
//        mapHeight = ((TiledMapTileLayer) tiledMap.getLayers().get(0)).getHeight(); // currently not used
        ...
        mario = new Mario(this, (worldCreator.getStartPosition().x + 8) / GameManager.PPM, (worldCreator.getStartPosition().y + 8) / GameManager.PPM, controller);
